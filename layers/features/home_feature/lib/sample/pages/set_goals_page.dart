...
class _SetGoalsPageState extends State<SetGoalsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("设置目标".tr)),
      body: Column(
              ...
              children: [
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(hintText: '2000-50000'),
              ...
              children: [
                ...
                Expanded(
                  child: TextField(
                    ...
                    textAlign: TextAlign.center,
                    decoration: InputDecoration(hintText: '1-200'),
                    keyboardType: TextInputType.number,
                    textInputAction: TextInputAction.done,
                    inputFormatters: [
                      FilteringTextInputFormatter.allow(
              ...
              children: [
                ...
                Expanded(
                  child: TextField(
                    ...
                    textAlign: TextAlign.center,
                    decoration: InputDecoration(hintText: '100-10000'),
                    keyboardType: TextInputType.number,
                    textInputAction: TextInputAction.done,
                    inputFormatters: [
                      FilteringTextInputFormatter.allow(
              ...
              children: [
                ...
                Expanded(
                  child: TextField(
                    ...
                    textAlign: TextAlign.center,
                    decoration: InputDecoration(hintText: '小时'.tr),
                    keyboardType: TextInputType.number,
                    textInputAction: TextInputAction.done,
                    inputFormatters: [
                      FilteringTextInputFormatter.allow(
                ...
                Expanded(
                  child: TextField(
                    ...
                    textAlign: TextAlign.center,
                    decoration: InputDecoration(hintText: '分钟'.tr),
                    keyboardType: TextInputType.number,
                    textInputAction: TextInputAction.done,
                    inputFormatters: [
                      FilteringTextInputFormatter.allow(
