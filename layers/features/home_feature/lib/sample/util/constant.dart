...
///常量类
class Constant {
  static String NOTIY = Platform.isAndroid
      ? "00002902-0000-1000-8000-00805f9b34fb"
      : "0000";
  static String SERVICE_DATA = Platform.isAndroid
      ? "0000fff0-0000-1000-8000-00805f9b34fb"
      : "FFF0";
  static String DATA_CHARACTERISTIC = Platform.isAndroid
      ? "0000fff6-0000-1000-8000-00805f9b34fb"
      : "FFF6";
  static String NOTIY_CHARACTERISTIC = Platform.isAndroid
