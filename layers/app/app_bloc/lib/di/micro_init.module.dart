...
// initializes the registration of main-scope dependencies inside of GetIt
  ...
  _i687.FutureOr<void> init(_i526.GetItHelper gh) {
    ...
    gh.factory<_i995.BluetoothScanCubit>(
        () => appBlocModule.injectBluetoothScanCubit(
              gh<_i211.BluetoothPermissionHandler>(),
              gh<_i211.BluetoothScanHandler>(),
              gh<_i211.FillerBoxHandler>(),
            ));
  }
}
