...
class AutoHeartRateIntervalPage extends StatefulWidget {
  ...
  @override
  State<AutoHeartRateIntervalPage> createState() =>
      _AutoHeartRateIntervalPageState();
}
...
class _AutoHeartRateIntervalPageState extends State<AutoHeartRateIntervalPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("自动心率区间".tr)),
      body: Column(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      controller.writeData(
                        BleSDK.GetAutomaticHRMonitoring(type),
                      );
                    },
                  ),
                ),
                ...
                child: Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      controller.writeData(
                        BleSDK.SetAutomaticHRMonitoring(info),
                      );
                    },
                  ),
                ),
